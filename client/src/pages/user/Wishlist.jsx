          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-muted text-sm line-clamp-2">
                {food.description || "Saved to your wishlist."}
              </p>
